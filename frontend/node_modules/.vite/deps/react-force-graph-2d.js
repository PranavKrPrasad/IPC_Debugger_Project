  ...
  if (null != t5) {
    ...
    try {
      if (i2 = (t5 = t5.call(r2)).next, 0 === l2)
        ...
        for (; !(f2 = (e3 = i2.call(t5)).done) && (a3.push(e3.value), a3.length !== l2); f2 = true)
          ;
    } catch (r3) {
      o2 = true, n2 = r3;
    } finally {
...
function dispatch() {
  for (var i2 = 0, n2 = arguments.length, _2 = {}, t5; i2 < n2; ++i2) {
    if (!(t5 = arguments[i2] + "") || t5 in _2 || /[\s.]/.test(t5))
...
Dispatch.prototype = dispatch.prototype = {
  ...
  on: function(typename, callback) {
    ...
    if (arguments.length < 2) {
      while (++i2 < n2)
        if ((t5 = (typename = T2[i2]).type) && (t5 = get(_2[t5], typename.name)))
          return t5;
      return;
    }
    ...
    while (++i2 < n2) {
      if (t5 = (typename = T2[i2]).type)
        _2[t5] = set(_2[t5], typename.name, callback);
      else if (callback == null)
        for (t5 in _2)
          _2[t5] = set(_2[t5], typename.name, null);
    }
    return this;
  },
  copy: function() {
  ...
  call: function(type, that) {
    ...
    for (t5 = this._[type], i2 = 0, n2 = t5.length; i2 < n2; ++i2)
      t5[i2].value.apply(that, args);
  },
  apply: function(type, that, args) {
    if (!this._.hasOwnProperty(type))
      throw new Error("unknown type: " + type);
    for (var t5 = this._[type], i2 = 0, n2 = t5.length; i2 < n2; ++i2)
      t5[i2].value.apply(that, args);
  }
};
...
function drag_default() {
  ...
  function mousedowned(event, d2) {
    if (touchending || !filter4.call(this, event, d2))
      return;
...
function timerFlush() {
  ...
  var t5 = taskHead, e3;
  while (t5) {
    if ((e3 = clockNow - t5._time) >= 0)
      t5._call.call(void 0, e3);
    t5 = t5._next;
  }
  --frame;
}
...
function zoom_default2() {
  ...
  function touchmoved(event, ...args) {
    ...
    for (i2 = 0; i2 < n2; ++i2) {
      t5 = touches[i2], p2 = pointer_default(t5, this);
      if (g2.touch0 && g2.touch0[2] === t5.identifier)
        g2.touch0[0] = p2;
      else if (g2.touch1 && g2.touch1[2] === t5.identifier)
        g2.touch1[0] = p2;
    }
    t5 = g2.that.__zoom;
    if (g2.touch1) {
...
function hslToRgb(h2, s2, l2) {
  ...
  function hue2rgb(p3, q3, t5) {
    ...
    if (t5 > 1)
      t5 -= 1;
    if (t5 < 1 / 6)
      return p3 + (q3 - p3) * 6 * t5;
    if (t5 < 1 / 2)
      return q3;
    if (t5 < 2 / 3)
      return p3 + (q3 - p3) * (2 / 3 - t5) * 6;
    return p3;
  }
  if (s2 === 0) {
    r2 = g2 = b = l2;
...
function _assertClassBrand(e3, t5, n2) {
  if ("function" == typeof e3 ? e3 === t5 : e3.has(t5))
    return arguments.length < 3 ? t5 : n2;
...
function _(l2, u2, t5) {
  var i2, r2, o2, e3 = {};
  for (o2 in u2)
    "key" == o2 ? i2 = u2[o2] : "ref" == o2 ? r2 = u2[o2] : e3[o2] = u2[o2];
  if (arguments.length > 2 && (e3.children = arguments.length > 3 ? n.call(arguments, 2) : t5), "function" == typeof l2 && null != l2.defaultProps)
...
function $() {
  for (var n2, u2, t5, r2, o2, f2, c5, s2 = 1; i.length; )
...
function I(n2, l2, u2, t5, i2, r2, o2, e3, f2, c5, s2) {
  ...
  for (f2 = P(u2, l2, m3, f2, b), a3 = 0; a3 < b; a3++)
    null != (y3 = u2.__k[a3]) && (h2 = -1 == y3.__i ? p : m3[y3.__i] || p, y3.__i = a3, g2 = O(n2, y3, h2, i2, r2, o2, e3, f2, c5, s2), w2 = y3.__e, y3.ref && h2.ref != y3.ref && (h2.ref && B2(h2.ref, null, y3), s2.push(y3.ref, y3.__c || w2, y3)), null == d2 && null != w2 && (d2 = w2), (_2 = !!(4 & y3.__u)) || h2.__k === y3.__k ? f2 = A2(y3, f2, n2, _2) : "function" == typeof y3.type && void 0 !== g2 ? f2 = g2 : w2 && (f2 = w2.nextSibling), y3.__u &= -7);
  return u2.__e = d2, f2;
}
function P(n2, l2, u2, t5, i2) {
  var r2, o2, e3, f2, c5, s2 = u2.length, a3 = s2, h2 = 0;
  for (n2.__k = new Array(i2), r2 = 0; r2 < i2; r2++)
    null != (o2 = l2[r2]) && "boolean" != typeof o2 && "function" != typeof o2 ? ("string" == typeof o2 || "number" == typeof o2 || "bigint" == typeof o2 || o2.constructor == String ? o2 = n2.__k[r2] = m(null, o2, null, null, null) : w(o2) ? o2 = n2.__k[r2] = m(k, { children: o2 }, null, null, null) : null == o2.constructor && o2.__b > 0 ? o2 = n2.__k[r2] = m(o2.type, o2.props, o2.key, o2.ref ? o2.ref : null, o2.__v) : n2.__k[r2] = o2, f2 = r2 + h2, o2.__ = n2, o2.__b = n2.__b + 1, -1 != (c5 = o2.__i = L(o2, u2, f2, a3)) && (a3--, (e3 = u2[c5]) && (e3.__u |= 2)), null == e3 || null == e3.__v ? (-1 == c5 && (i2 > s2 ? h2-- : i2 < s2 && h2++), "function" != typeof o2.type && (o2.__u |= 4)) : c5 != f2 && (c5 == f2 - 1 ? h2-- : c5 == f2 + 1 ? h2++ : (c5 > f2 ? h2-- : h2++, o2.__u |= 4))) : n2.__k[r2] = null;
  if (a3)
    for (r2 = 0; r2 < s2; r2++)
      null != (e3 = u2[r2]) && 0 == (2 & e3.__u) && (e3.__e == t5 && (t5 = S(e3)), D2(e3, e3));
  return t5;
}
function A2(n2, l2, u2, t5) {
  ...
  if ("function" == typeof n2.type) {
    for (i2 = n2.__k, r2 = 0; i2 && r2 < i2.length; r2++)
      i2[r2] && (i2[r2].__ = n2, l2 = A2(i2[r2], l2, u2, t5));
    return l2;
  }
...
function L(n2, l2, u2, t5) {
  ...
  if (null === c5 && null == e3 || s2 && e3 == c5.key && f2 == c5.type)
    return u2;
  if (t5 > (s2 ? 1 : 0)) {
    for (i2 = u2 - 1, r2 = u2 + 1; i2 >= 0 || r2 < l2.length; )
      if (null != (c5 = l2[o2 = i2 >= 0 ? i2-- : r2++]) && 0 == (2 & c5.__u) && e3 == c5.key && f2 == c5.type)
        return o2;
  }
  return -1;
}
  ...
  n:
    if ("style" == l2)
      if ("string" == typeof u2)
        ...
        if ("string" == typeof t5 && (n2.style.cssText = t5 = ""), t5)
          for (l2 in t5)
            u2 && l2 in u2 || T(n2.style, l2, "");
        if (u2)
          for (l2 in u2)
            t5 && u2[l2] == t5[l2] || T(n2.style, l2, u2[l2]);
      }
    else if ("o" == l2[0] && "n" == l2[1])
      r2 = l2 != (l2 = l2.replace(f, "$1")), o2 = l2.toLowerCase(), l2 = o2 in n2 || "onFocusOut" == l2 || "onFocusIn" == l2 ? o2.slice(2) : l2.slice(2), n2.l || (n2.l = {}), n2.l[l2 + r2] = u2, u2 ? t5 ? u2.u = t5.u : (u2.u = c, n2.addEventListener(l2, r2 ? a : s, r2)) : n2.removeEventListener(l2, r2 ? a : s, r2);
    else {
...
function O(n2, u2, t5, i2, r2, o2, e3, f2, c5, s2) {
  ...
  n:
    if ("function" == typeof j2)
      try {
        if (b = u2.props, S2 = "prototype" in j2 && j2.prototype.render, C3 = (a3 = j2.contextType) && i2[a3.__c], M2 = a3 ? C3 ? C3.props.value : a3.__ : i2, t5.__c ? m3 = (h2 = u2.__c = t5.__c).__ = h2.__E : (S2 ? u2.__c = h2 = new j2(b, M2) : (u2.__c = h2 = new x(b, M2), h2.constructor = j2, h2.render = E2), C3 && C3.sub(h2), h2.state || (h2.state = {}), h2.__n = i2, p2 = h2.__d = true, h2.__h = [], h2._sb = []), S2 && null == h2.__s && (h2.__s = h2.state), S2 && null != j2.getDerivedStateFromProps && (h2.__s == h2.state && (h2.__s = d({}, h2.__s)), d(h2.__s, j2.getDerivedStateFromProps(b, h2.__s))), v2 = h2.props, y3 = h2.state, h2.__v = u2, p2)
        ...
        if (u2.__v = null, c5 || null != o2)
          if (n3.then) {
            for (u2.__u |= c5 ? 160 : 128; f2 && 8 == f2.nodeType && f2.nextSibling; )
              f2 = f2.nextSibling;
          ...
          u2.__e = t5.__e, u2.__k = t5.__k, n3.then || z(u2);
        l.__e(n3, u2, t5);
      }
    else
      null == o2 && u2.__v == t5.__v ? (u2.__k = t5.__k, u2.__e = t5.__e) : f2 = u2.__e = q(t5.__e, u2, t5, i2, r2, o2, e3, c5, s2);
...
function q(u2, t5, i2, r2, o2, e3, f2, c5, s2) {
  var a3, h2, v2, y3, d2, _2, m3, b = i2.props || p, k2 = t5.props, x3 = t5.type;
  if ("svg" == x3 ? o2 = "http://www.w3.org/2000/svg" : "math" == x3 ? o2 = "http://www.w3.org/1998/Math/MathML" : o2 || (o2 = "http://www.w3.org/1999/xhtml"), null != e3) {
    for (a3 = 0; a3 < e3.length; a3++)
      if ((d2 = e3[a3]) && "setAttribute" in d2 == !!x3 && (x3 ? d2.localName == x3 : 3 == d2.nodeType)) {
        u2 = d2, e3[a3] = null;
        break;
      }
  }
  ...
  if (null == x3)
    b === k2 || c5 && u2.data == k2 || (u2.data = k2);
  else {
    if (e3 = e3 && n.call(u2.childNodes), !c5 && null != e3)
    ...
    for (a3 in k2)
      d2 = k2[a3], "children" == a3 ? y3 = d2 : "dangerouslySetInnerHTML" == a3 ? h2 = d2 : "value" == a3 ? _2 = d2 : "checked" == a3 ? m3 = d2 : c5 && "function" != typeof d2 || b[a3] === d2 || j(u2, a3, d2, b[a3], o2);
    if (h2)
      c5 || v2 && (h2.__html == v2.__html || h2.__html == u2.innerHTML) || (u2.innerHTML = h2.__html), t5.__k = [];
    else if (v2 && (u2.innerHTML = ""), I("template" == t5.type ? u2.content : u2, w(y3) ? y3 : [y3], t5, i2, r2, "foreignObject" == x3 ? "http://www.w3.org/1999/xhtml" : o2, e3, f2, e3 ? e3[0] : i2.__k && S(i2, 0), c5, s2), null != e3)
      for (a3 = e3.length; a3--; )
        g(e3[a3]);
...
function D2(n2, u2, t5) {
  ...
  if (i2 = n2.__k)
    for (r2 = 0; r2 < i2.length; r2++)
      i2[r2] && D2(i2[r2], u2, t5 || "function" != typeof n2.type);
...
function K2(l2, u2, t5) {
  ...
  for (o2 in l2.type && l2.type.defaultProps && (e3 = l2.type.defaultProps), u2)
    "key" == o2 ? i2 = u2[o2] : "ref" == o2 ? r2 = u2[o2] : f2[o2] = void 0 === u2[o2] && null != e3 ? e3[o2] : u2[o2];
...
n = v.slice, l = { __e: function(n2, l2, u2, t5) {
  for (var i2, r2, o2; l2 = l2.__; )
    if ((i2 = l2.__c) && !i2.__)
      try {
        if ((r2 = i2.constructor) && null != r2.getDerivedStateFromError && (i2.setState(r2.getDerivedStateFromError(n2)), o2 = i2.__d), null != i2.componentDidCatch && (i2.componentDidCatch(n2, t5 || {}), o2 = i2.__d), o2)
          return i2.__E = i2;
      } catch (l3) {
        n2 = l3;
      }
...
function add3(tree, x3, d2) {
  ...
  while (node.length) {
    if (right = x3 >= (xm = (x0 + x1) / 2))
      ...
      x1 = xm;
    if (parent2 = node, !(node = node[i2 = +right]))
      return parent2[i2] = leaf, tree;
  }
  xp = +tree._x.call(null, node.data);
  if (x3 === xp)
    return leaf.next = node, parent2 ? parent2[i2] = leaf : tree._root = leaf, tree;
  do {
...
function add4(tree, x3, y3, d2) {
  ...
  while (node.length) {
    ...
    if (bottom = y3 >= (ym = (y0 + y1) / 2))
      ...
      y1 = ym;
    if (parent2 = node, !(node = node[i2 = bottom << 1 | right]))
      return parent2[i2] = leaf, tree;
  }
  xp = +tree._x.call(null, node.data);
...
function remove_default5(d2) {
  ...
  if (node.length)
    while (true) {
      ...
      if (!node.length)
        break;
      if (parent2[i2 + 1 & 3] || parent2[i2 + 2 & 3] || parent2[i2 + 3 & 3])
        retainer = parent2, j2 = i2;
    }
  while (node.data !== d2)
    if (!(previous = node, node = node.next))
...
function add5(tree, x3, y3, z3, d2) {
  ...
  while (node.length) {
    ...
    if (deep = z3 >= (zm = (z0 + z1) / 2))
      ...
      z1 = zm;
    if (parent2 = node, !(node = node[i2 = deep << 2 | bottom << 1 | right]))
      return parent2[i2] = leaf, tree;
  }
  xp = +tree._x.call(null, node.data);
  yp = +tree._y.call(null, node.data);
...
function remove_default6(d2) {
  ...
  if (node.length)
    while (true) {
      ...
      if (!node.length)
        break;
      if (parent2[i2 + 1 & 7] || parent2[i2 + 2 & 7] || parent2[i2 + 3 & 7] || parent2[i2 + 4 & 7] || parent2[i2 + 5 & 7] || parent2[i2 + 6 & 7] || parent2[i2 + 7 & 7])
        retainer = parent2, j2 = i2;
    }
  while (node.data !== d2)
    if (!(previous = node, node = node.next))
...
function manyBody_default() {
  ...
  function force(_2) {
    ...
    for (alpha = _2, i2 = 0; i2 < n2; ++i2)
      node = nodes[i2], tree.visit(apply2);
  }
  function initialize() {
    if (!nodes)
      return;
  ...
  function apply2(treeNode, x1, arg1, arg2, arg3) {
    ...
    if (w2 * w2 / theta2 < l2) {
      if (l2 < distanceMax2) {
        if (x3 === 0)
          x3 = jiggle_default(random2), l2 += x3 * x3;
        if (nDim > 1 && y3 === 0)
          y3 = jiggle_default(random2), l2 += y3 * y3;
        if (nDim > 2 && z3 === 0)
          z3 = jiggle_default(random2), l2 += z3 * z3;
        if (l2 < distanceMin2)
...
function _objectWithoutProperties(e3, t5) {
  ...
  if (Object.getOwnPropertySymbols) {
    ...
    for (r2 = 0; r2 < s2.length; r2++)
      o2 = s2[r2], t5.includes(o2) || {}.propertyIsEnumerable.call(e3, o2) && (i2[o2] = e3[o2]);
  }
  return i2;
}
...
function _unsupportedIterableToArray6(r2, a3) {
  if (r2) {
    if ("string" == typeof r2)
      return _arrayLikeToArray6(r2, a3);
    var t5 = {}.toString.call(r2).slice(8, -1);
    ...
    return function(date) {
      ...
      while (++i2 < n2) {
        if (specifier.charCodeAt(i2) === 37) {
          ...
          if ((pad4 = pads[c5 = specifier.charAt(++i2)]) != null)
            c5 = specifier.charAt(++i2);
          else
            pad4 = c5 === "e" ? " " : "0";
          if (format2 = formats2[c5])
            c5 = format2(date, pad4);
          string.push(c5);
          j2 = i2 + 1;
        }
      }
...
function _unsupportedIterableToArray7(r2, a3) {
  if (r2) {
    if ("string" == typeof r2)
      return _arrayLikeToArray7(r2, a3);
    var t5 = {}.toString.call(r2).slice(8, -1);
